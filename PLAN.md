...
| #70 | Projects page | "close all ×" control (mobile only) collapses selection + featured panel — not in any Figma frame | Ryan asked for a close-all option; desktop hover re-selects instantly so it's mobile-only. |
